          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    child: Image.asset("imagens_atm/menu_empresa.png"),
                    onTap: abrirEmpresa,
                  ),
                  const SizedBox(
                    width: 34,
                  ...
                  GestureDetector(
                    child: Image.asset("imagens_atm/menu_servico.png"),
                    onTap: abrirServico,
                  ),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    child: Image.asset("imagens_atm/menu_contato.png"),
                    onTap: abrirContato,
                  ),
                  const SizedBox(
                    width: 34,
                  ...
                  GestureDetector(
                    child: Image.asset("imagens_atm/menu_cliente.png"),
                    onTap: abrirCliente,
                  ),
                ],
              ),
